...
public class DefaultDatabase {
    public DefaultDatabase() {
        Database.delete();
        UserController.AddUser("Mouaaz","mmsmms@gmail.com","123456789");
        ...
        for(Movie m : Database.movies){
            ...
            showtimes.get(0).date.plusHours(12);
            showtimes.get(1).date.plusHours(12);
            showtimes.get(2).date.plusHours(12);
        }
        Database.save();
