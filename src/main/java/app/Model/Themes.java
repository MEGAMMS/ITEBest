...
public class Themes implements Serializable {
        ...
        static {
                ...
                themes.add(new String[] { "#AF2655", "#D17292", "#860A35", "#FDF7E4", "#EBE3D5", "#EAD7BB", "#aa8f55",
                ...
                themes.add(new String[] { "#ACAEC3", "#6B728E", "#404258", "#50577A", "#282A3A", "#474E68", "#6B728E",
        ...
        public static void setTheme(int n) {
                Database.currTheme = n;
        }
        public static String[] getTheme(){
                return themes.get(Database.currTheme);
        }
}
